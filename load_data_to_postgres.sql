...
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/stock_data_wiki_clean.csv' 
DELIMITER ',' 
CSV HEADER;

-- Load S&P 500 data
\COPY sp500_data(date, sp500_open, sp500_high, sp500_low, sp500_close, sp500_volume, sp500_return, sp500_volatility) 
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/SP500_data.csv' 
DELIMITER ',' 
CSV HEADER;

-- Load depression index (Google Trends - weekly)
\COPY depression_index(week_start_date, depression_index) 
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/Depression_index_data.csv' 
DELIMITER ',' 
CSV HEADER;

-- Load depression word count (daily news mentions)
\COPY depression_word_count(date, word_count) 
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/CCnews_Depression_data.csv' 
DELIMITER ',' 
CSV HEADER;

-- Load rainfall data
\COPY rainfall_data(date, rainfall_mm) 
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/Rainfall_data.csv' 
DELIMITER ',' 
CSV HEADER;
...
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/merged_time_series_data.csv' 
DELIMITER ',' 
CSV HEADER;
...
FROM '/Users/boahkim/Documents/GitHub/Fundamentals-of-Data-Engineering/correlation_statistics_full.csv' 
DELIMITER ',' 
CSV HEADER;
