...
def create_data_loaders(
    ...
    # No class balancing - use all images as-is
    print(f"\nUsing all original images without balancing...")
    print(f"  Total images: {len(all_paths)}")
    
    # Show final distribution
    final_counts = pd.Series(all_labels).value_counts()
    print(f"\nFinal class distribution (no balancing):")
